 ...
 * Generated at: 2016-03-17 14:25:54 UTC
...
public final class VueEspaceP_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("<title>Espace Producteur</title>\r\n");
 ...
 Vector<Commerce> commerceVector = (Vector<Commerce>) session.getAttribute("LCommerceP");
	...
	for(int i=0;i<commerceVector.size();i++){
      ...
      out.write("\t\t\t\t\t\t<div><a href=\"VueUpload.jsp\" >Proposer un nouveau producteur</a></div>\r\n");
