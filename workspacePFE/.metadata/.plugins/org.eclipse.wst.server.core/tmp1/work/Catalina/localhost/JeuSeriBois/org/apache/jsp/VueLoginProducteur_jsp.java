 ...
 * Generated at: 2016-03-17 14:25:35 UTC
...
public final class VueLoginProducteur_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("<title>Login Producteur</title>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t<form name=\"client\" method=\"post\" action=\"LoginPServlet\"> >\r\n");
      out.write("\t\t\t\t\t\t<div id=\"login-username\">\r\n");
      out.write("\t\t\t\t\t\t\t<div><label for=\"username\">Adresse Mail</label>: <input name=\"adresseM\"type=\"text\" /></div>\r\n");
      out.write("\t\t\t\t\t\t\t<div><label for=\"password\">password</label>: <input name=\"cle\"type=\"text\" /></div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
